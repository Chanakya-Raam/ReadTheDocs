...
.. list-table:: 
   ...
   * - POST
     - /battery_pack
     - Create a new battery pack or upload in bulk
   * - DELETE
     - /battery_pack
     - Delete a group of battery packs
   * - GET
     - /battery_pack
     - Read the properties of a group of battery packs
   * - PATCH
     - /battery_pack
     - Update the properties of a group of battery packs
   * - DELETE
     - /battery_pack/{i}
     - Delete an individual battery pack
   * - GET
     - /battery_pack/{i}
     - Read the properties of an individual battery pack
   * - PATCH
     - /battery_pack/{i}
     - Update the properties of an individual battery pack
   * - POST
     - /battery_pack/{i}/allocate
     - Allocate a battery pack to another entity
   * - POST
     - /battery_pack/{i}/enable
     - Enable or disable a battery pack
